...
lines = (ROOT / 'source_evidence/chat.cast').read_text().splitlines()
...
for index, fragment in enumerate(fragments):
    ...
    draw.text((40, 78), 'source_expanded | 3,000 updates | 48-token context | fresh prompt each turn', font=font, fill='#9ec9e8')
    ...
    frames.append(image)
frames[-1].save(ROOT / 'source_evidence/chat_recording_still.png')
frames[0].save(ROOT / 'source_evidence/chat_recording.gif', save_all=True,
